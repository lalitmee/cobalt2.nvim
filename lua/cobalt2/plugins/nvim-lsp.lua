...
Group.new("LspDiagnosticsDefaultHint", colors.pink, nil, nil)
...
Group.new("LspDiagnosticsHint", colors.pink, nil, nil)
...
Group.new("LspDiagnosticsVirtualTextHint", colors.pink, nil, nil)
...
Group.new("LspDiagnosticsHintUnderline", colors.pink, nil, styles.underline)
