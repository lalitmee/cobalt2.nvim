...
Group.new('Cursor', colors.cobalt_bg, colors.yellow, nil)
Group.new('CursorColumn', nil, colors.yellow, nil)
Group.new('CursorLine', nil, colors.dirty_blue, nil)
Group.new('CursorLineNr', colors.light_blue, nil, styles.NONE)
Group.new('LineNr', colors.dark_grey, colors.cobalt_bg, styles.NONE)
...
Group.new('SignColumn', colors.dark_grey, colors.darkest_grey, nil)
